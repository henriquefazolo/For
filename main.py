'''
Crie um código utilizando LAÇO FOR:
a. Enquanto a1=0 for menor que 5, incrementando 1 a cada laço,
mostre na tela o seu número.

b. Enquanto a2=0 for menor que 3, incrementando 1 a cada laço,
mostre na tela o seu número multiplicado por 10.

c. Enquanto a3=20 for maior que 10, decrementando 1 a cada
laço, mostre na tela o seu número.

d. Para a4=0 enquanto a4 menor que 10, incrementando 1, mostre
